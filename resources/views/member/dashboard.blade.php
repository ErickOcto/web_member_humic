...
@section('dashboard-content')
    ...
    <div class="card border-0" style="border-radius: 16px; background-color: #f6f6f6; width:60%;">
        <div class="row">
                ...
                <div class="col-12 col-lg-5 m-3 offset-lg-1">
